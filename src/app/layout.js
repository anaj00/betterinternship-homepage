  ...
  return (
    <html lang="en">
      ...
      <body>
        <Providers>
          <HeroNavbar />
          <main className="px-0 sm:px-6 sm:pt-4 flex flex-col items-center justify-center min-h-screen overflow-x-hidden">{children}</main>
          <footer className="w-auto text-gray-700 px-6 py-12 bg-white border border-gray-300">
            <div className="flex flex-col sm:flex-row justify-between gap-12 px-20">
              {/* Brand Info */}
